...
class MainActivity extends React.Component {
  ...
  InsertStudentRecordsToServer = () => {
    ...
    fetch('http://192.168.1.5:8089/rnacademic/InsertStudentData.php', {
      method: 'POST',
      headers: {
...
class ShowStudentListActivity extends React.Component {
  ...
  componentDidMount() {
    fetch('http://192.168.1.5:8089/rnacademic/ShowAllStudentsList.php', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
class EditStudentRecordActivity extends React.Component {
  ...
  UpdateStudentRecord = () => {
    fetch('http://192.168.1.5:8089/rnacademic/UpdateStudentRecord.php', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  DeleteStudentRecord = () => {
    fetch('http://192.168.1.5:8089/rnacademic/DeleteStudentRecord.php', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
